<div id="affwp-affiliate-dashboard-payouts" class="affwp-tab-content">
    <div class="container">
        <h3><?php _e('Referral Payouts', 'gfx'); ?></h3>
        ...
        <div class="table-holder-bg">
            <div class="table-holder">
                <table id="affwp-affiliate-dashboard-payouts" aria-describedby="affwp-table-summary">
                    <thead>
                    <tr>
                        <th class="payout-date"><?php _e( 'Date', 'gfx' ); ?></th>
                        <th class="payout-amount"><?php _e( 'Amount', 'gfx' ); ?></th>
                        <th class="payout-method"><?php _e( 'Payout Method', 'gfx' ); ?></th>
                        <?php if ( true === $payouts_service_enabled ): ?>
                            <th class="payout-account"><?php _e( 'Payout Account', 'gfx' ); ?></th>
                        <?php endif; ?>
                        <th class="payout-status"><?php _e( 'Status', 'gfx' ); ?></th>
                        <?php if ( true === $payouts_service_enabled ): ?>
                            <th class="payout-account"><?php _e( 'Estimated Arrival Date', 'gfx' ); ?></th>
                        <?php endif; ?>
                        <?php
                        /**
                    ...
                    <?php else : ?>
                        ...
                        <tr>
                            <td class="affwp-table-no-data" colspan="<?php echo true === $payouts_service_enabled ? 6 : 4; ?>"><?php _e( 'None of your referrals have been paid out yet.', 'gfx' ); ?></td>
                        </tr>
