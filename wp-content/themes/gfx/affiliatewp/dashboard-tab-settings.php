        ...
        <form id="affwp-affiliate-dashboard-profile-form" class="affwp-form" method="post">
            ...
            <?php if (affwp_email_referral_notifications(absint($affiliate_id))) : ?>
                <div class="affwp-wrap affwp-send-notifications-wrap">
                    <input id="affwp-referral-notifications" type="checkbox" name="referral_notifications"
                           value="1" <?php checked(true, get_user_meta($affiliate_user_id, 'affwp_referral_notifications', true)); ?>/>
                    <label for="affwp-referral-notifications"><?php _e('Enable New Referral Notifications', 'gfx'); ?></label>
                </div>
            <?php endif; ?>
            ...
            <div class="affwp-save-profile-wrap">
                ...
                <input type="submit" class="primary-button"
                       value="<?php esc_attr_e('Save Profile Settings', 'gfx'); ?>"/>
            </div>
