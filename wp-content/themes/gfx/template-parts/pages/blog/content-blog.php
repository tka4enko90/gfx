...
if ($page_id) :
    ...
    if (is_category()) {
        ...
        $blog_page_id = get_page_by_title('Rescourses');
    ...
    if ($page_title || $blog_hero_subtitle) :
        get_template_part('template-parts/blocks/hero_search/hero-search', '', array('title' => $page_title, 'subtitle' => $blog_hero_subtitle, 'search_type' => $search_type));
    endif;
endif;
