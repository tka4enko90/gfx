        ...
        <div class="container">
            <div class="section-holder">
                ...
                <div class="content-column">
                    ...
                    <span class="post-date"><?php if( !empty($args['custom_date']) ) {
                            echo $args['custom_date'];
                        } else { ?>
                            <?php echo get_the_time('Y-m-d', $args['post_id'] ); ?>
                            <?php
                        } ?></span>
                    <h2 class="post-title"><?php if( ! empty( $args['custom_title'] ) ) {
                            echo $args['custom_title'];
                        } else {
                            echo get_the_title( $args['post_id'] );
                        } ?></h2>
                    <p class="post-excerpt"><?php if( ! empty( $args['custom_description'] ) ) {
