<?php wp_enqueue_style('blog_posts_grid_css', get_template_directory_uri() . '/static/css/template-parts/blocks/blog_posts_grid/blog-posts-grid.css', '', '', 'all'); ?>

<section class="blog-posts-grid">
    <div class="container">
        <div class="posts-grid">
            <?php while (have_posts()) : the_post(); ?>
                <?php get_template_part('template-parts/blocks/blog_posts_grid/post-card'); ?>
            <?php endwhile; ?>
        </div>
