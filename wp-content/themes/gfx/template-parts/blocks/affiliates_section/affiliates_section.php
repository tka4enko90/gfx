        ...
        <div class="container">
            <div class="section-holder">
                <div class="content-column">
                    <?php if (!empty($paffiliates_section_settings['section_title'])) {
