        ...
        <form action="" id="product-filtration-form" method="GET">
            ...
            <div class="section-holder">
                ...
                if (isset($_GET["sort-by"])) :
                    ...
                    if($sort_by == 'date-new-old') {
                        $args['orderby'] = "date";
                        $args['order'] = "DESC";
                    }

                    if($sort_by == 'date-old-new') {
                        $args['orderby'] = "date";
                        $args['order'] = "ASC";
                    }

                    if($sort_by == 'alphabetically-a-z') {
                        $args['orderby'] = "title";
                        $args['order'] = "ASC";
                    }

                    if($sort_by == 'alphabetically-z-a') {
                        $args['orderby'] = "title";
                        $args['order'] = "DESC";
                    }
