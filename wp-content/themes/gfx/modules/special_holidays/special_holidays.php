<?php
	...
	wp_enqueue_style( 'special_holidays_styles', get_template_directory_uri() . '/static/css/modules/special_holidays/special_holidays.css', '', '', 'all' );
	$special_holidays_background_id         = get_sub_field( 'special_holidays_background_id' );
			...
			<?php if ( $special_holidays_subtitle || $special_holidays_title ) : ?>
				<div class="content-col">
					...
					<?php if ( $special_holidays_button && $special_holidays_button['url'] ) : ?>
						<a href="<?php echo $special_holidays_button['url']; ?>" class="primary-button" target="
							<?php
							echo ! empty( $special_holidays_button['target'] )
							? $special_holidays_button['target'] : '_self';
							?>
							">
