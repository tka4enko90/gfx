<?php if (isset($product) && $product instanceof WC_Product) :
    if ($product->get_type() == 'woosb') :
        ...
        if (isset($bundled_items) && !empty($bundled_items)) : ?>
            <?php wp_enqueue_style('single_product_also_from_this_package_css', get_template_directory_uri() . '/static/css/modules/single_product_also_from_this_package/single-product-also-from-this-package.css', '', '', 'all'); ?>
