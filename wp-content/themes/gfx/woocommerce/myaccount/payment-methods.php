...
<div class="my-account-info-block payment-methods-section">
    <?php do_action('woocommerce_before_account_payment_methods', $has_methods); ?>

    <h3><?php _e('Payment Methods', 'gfx'); ?></h3>
    ...
    <?php else : ?>
        <div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
            <?php esc_html_e('No saved methods found.', 'gfx'); ?>
        </div>
    <?php endif; ?>
    ...
    <?php if (WC()->payment_gateways->get_available_payment_gateways()) : ?>
        <div class="button-holder">
            <a class="primary-button small" href="<?php echo esc_url(wc_get_endpoint_url('add-payment-method')); ?>">
