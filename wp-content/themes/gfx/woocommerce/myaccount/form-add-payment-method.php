...
<div class="my-account-info-block add-payment-method-section">
            ...
            <div id="payment" class="woocommerce-Payment">
                <div class="woocommerce-PaymentMethods payment_methods methods">
                    ...
                    foreach ($available_gateways as $gateway) : ?>
                        <div class="form-row woocommerce-PaymentMethod woocommerce-PaymentMethod--<?php echo esc_attr($gateway->id); ?> payment_method_<?php echo esc_attr($gateway->id); ?>">
                ...
                <div class="form-row">
                    ...
                    <button type="submit" class="primary-button small" id="place_order" value="<?php esc_attr_e('Add payment method', 'gfx'); ?>">
                        <?php esc_html_e('Add payment method', 'gfx'); ?>
                    </button>
    ...
    <?php else : ?>
        <div class="woocommerce-notice woocommerce-notice--info woocommerce-info">
            <?php esc_html_e('New payment methods can only be added during checkout. Please contact us if you require assistance.', 'gfx'); ?>
        </div>
    <?php endif; ?>
</div>