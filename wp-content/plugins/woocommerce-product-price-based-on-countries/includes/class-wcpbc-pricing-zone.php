...
class WCPBC_Pricing_Zone {
	...
	public function set_zone_id( $id ) {
		wc_deprecated_function( 'WCPBC_Pricing_Zone::set_zone_id', '2.1.0', 'WCPBC_Pricing_Zone::set_id' );
	...
	public function get_zone_id() {
		wc_deprecated_function( 'WCPBC_Pricing_Zone::get_zone_id', '2.1.0', 'WCPBC_Pricing_Zone::get_id' );
