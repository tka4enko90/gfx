...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'Enter a fee (percentage) to increment the auto exchange rate.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'Round up the price by exchange rate to the nearest. The result will be a multiple of the value that you select.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
	<td class="forminp forminp-select">
	<?php
...
<!-- Round the price tax included -->
<?php if ( wc_tax_enabled() && 'incl' === get_option( 'woocommerce_tax_display_shop' ) && ! wc_prices_include_tax() ) : ?>
<tr valign="top">
	<th scope="row" class="titledesc">
		<label for="round_after_taxes"><?php esc_html_e( 'Round After Tax', 'wc-price-based-country-pro' ); ?></label>
	</th>
	<td class="forminp forminp-checkbox">
		<fieldset>
			<legend class="screen-reader-text"><span><?php esc_html_e( 'Round the price after WooCommerce adds the taxes', 'wc-price-based-country-pro' ); ?>.</span></legend>
			<label for="round_after_taxes">
				<input name="round_after_taxes" id="round_after_taxes" type="checkbox" <?php echo $zone->get_round_after_taxes() ? 'checked="checked"' : ''; ?> value="1">
				<?php
				esc_html_e( 'Round the price after WooCommerce adds the taxes', 'wc-price-based-country-pro' );
				?>
			</label>
			<p class="description"><?php esc_html_e( 'Check this box if you want to display rounded prices with tax included in the shop.', 'wc-price-based-country-pro' ); ?></p>
		</fieldset>
	</td>
</tr>
<?php endif; ?>
...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'Enter the currency format. Supports the following placeholders: [code] = currency code, [symbol] = currency symbol, [symbol-alt] = alternative currency symbol (US$, CA$, ...), [price] = product price.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'This sets the thousand separator of displayed prices.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
	<td class="forminp forminp-text">
...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'This sets the decimal separator of displayed prices.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
	<td class="forminp forminp-text">
...
<tr valign="top">
	<th scope="row" class="titledesc">
		<label for="trim_zeros"><?php esc_html_e( 'Trailing Zeros', 'wc-price-based-country-pro' ); ?></label>
	</th>
	<td class="forminp forminp-checkbox">
		<fieldset>
			<legend class="screen-reader-text"><span><?php esc_html_e( 'Hide trailing zeros on prices', 'wc-price-based-country-pro' ); ?>.</span></legend>
			<label for="trim_zeros">
				<input name="trim_zeros" id="trim_zeros" type="checkbox" <?php echo $zone->get_trim_zeros() ? 'checked="checked"' : ''; ?> value="1">
				<?php
				esc_html_e( 'Hide trailing zeros on prices', 'wc-price-based-country-pro' );
				?>
			</label>
		</fieldset>
	</td>
...
<tr valign="top">
	<th scope="row" class="titledesc">
		...
		<?php echo wc_help_tip( __( 'This sets the number of decimal points shown in displayed prices.', 'wc-price-based-country-pro' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</th>
	<td class="forminp forminp-text">
