				...
				if ( ! isset( self::$data[ $order_id ] ) ) {
					...
					if ( count( $order_items ) > 0 ) {
						...
						foreach ( $order_items as $item_id => $item ) {
							...
							$product       = defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '4.4.0', '<' ) ? $order->get_product_from_item( $item ) : $item->get_product();
