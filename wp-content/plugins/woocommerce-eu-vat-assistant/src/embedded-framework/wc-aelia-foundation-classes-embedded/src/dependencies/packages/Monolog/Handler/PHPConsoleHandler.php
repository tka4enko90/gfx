...
namespace Aelia\Dependencies\Monolog\Handler;

use Exception;
use Aelia\Dependencies\Monolog\Formatter\LineFormatter;
...
/**
 * Aelia\Dependencies\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \Aelia\Dependencies\Monolog\Logger('all', array(new \Aelia\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \Aelia\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Aelia\Dependencies\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \Aelia\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details
